...
基于 Python Tkinter 开发的可视化本地大模型聊天工具，支持 Ollama 本地模型与火山方舟·豆包 API 无缝切换，自带上下文管理、聊天记录持久化、导出、个性化配置等完整功能。
...
- 便捷快捷键：回车发送、Shift+回车换行、Ctrl+N 新建对话
...
### Linux 安装 tkinter（如缺失）
```bash
sudo apt-get install python3-tk
```

> tkinter 通常随 Python 自带，Windows/macOS 一般无需额外安装。
